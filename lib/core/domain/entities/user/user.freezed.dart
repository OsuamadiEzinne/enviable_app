...
class _$_User with DiagnosticableTreeMixin implements _User {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'User(id: $id, role: $role, displayName: $displayName, email: $email, isEmailVerified: $isEmailVerified, provider: $provider, providers: $providers, phone: $phone, photo: $photo, createdAt: $createdAt, lastSeenAt: $lastSeenAt)';
  }
